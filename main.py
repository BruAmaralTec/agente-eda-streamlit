...
# ... (código de configuração da página e título, não precisa mudar) ...
st.set_page_config(page_title="Agente de E.D.A. Bru Amaral", layout="wide")
st.title("🤖 Agente de E.D.A. da Bru Amaral")

# ... (código da barra lateral, não precisa mudar) ...
